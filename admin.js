...
const databasee = require('./database.json')
...
//наполнение BD
//databasee.films.forEach(f => new Film(f).save().catch(e => console.log(e)))
//databasee.cinemas.forEach(f => new Cinema(f).save().catch(e => console.log(e)))
//константы для колбэк событий избранного
const ACTION_TYPE = {
	TOGGLE_FAV_FILM: 'tff',
	SHOW_CINEMAS: 'sc',
